...
class Menu:
    ...
    def __init__(self, opciones):
        self.opciones = []
        fuente = pygame.font.Font('dejavu.ttf', 55)
        x = 404
        y = 250
        paridad = 1

        self.cursor = Cursor(x - 30, -200 + (y * 2), 65)
...
if __name__ == '__main__':
    ...
    pygame.font.init()
    screen = pygame.display.set_mode((1024, 764))
    fondo = pygame.image.load('Pixel_Art/Backgrounds/Background.png').convert()
    menu = Menu(opciones)
